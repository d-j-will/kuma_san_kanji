defmodule KumaSanKanjiWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: KumaSanKanjiWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KumaSanKanjiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KumaSanKanjiWeb.Gettext, "errors", msg, opts)
    end
  end
