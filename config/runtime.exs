...
#
#     PHX_SERVER=true bin/kuma_san_kanji start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kuma_san_kanji, KumaSanKanjiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :kuma_san_kanji, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :kuma_san_kanji, KumaSanKanji.Mailer,
